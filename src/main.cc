        ...
        if (m)
        {
          ...
          if (sim.run)
          {
            ...
            if (initialpos == true)
            {
              ...
              d->qpos[12] = 30.0 * DEG2RAD; // to avoid self collision
            ...
            else
            {
              ...
              //       d->xmat[125] = 0.324;
              Control.write(d->ctrl);
              // void write(double* torque, double* goal_pos_mj);
            ...
            sim.applyposepertubations(1); // move mocap bodies only
...
int main(int argc, const char **argv)
{
  ...
  // char str[100] = "../model/fr3.xml"; // hand(xml)
  char str[100] = "/home/kist-robot2/Franka/franka_panda_xl_steel/fr3_xl_huscky/scene_dual_fr3.xml";
#if defined(__APPLE__) && defined(__AVX__)
