...
private:
	...
	void cost_function(int _sampling);
	...
	double _cost_sum, _NN_output, _dt, dT, _alpha, _beta, _random_matrix[7][300][40], _min_cost;
	...
	VectorXd _cost1, _cost2, _min_joint_position, _max_joint_position, _q_goal, _qdot_init, _q_init;
	VectorXd _next_acc_state, _A, _B, _weighted_A, _weighted_B, _temp_vec, _q_des, _qdot_des, _cost_joint, weight_sum;
