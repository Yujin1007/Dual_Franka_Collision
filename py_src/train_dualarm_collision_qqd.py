...
def main(dataset_path, model_path, isTrain, batch_size):
    ...
    for chunk in chunks:
        ...
        X_chunk = chunk.iloc[:, :input_size].values
        Y_chunk = chunk.iloc[:, input_size].values.reshape(-1, 1)
    ...
    if isTrain:
        ...
        for epoch in range(num_epochs):
            ...
            if (epoch+1) % 1 == 0: # heavy
                ...
                print("정확도 : ", accuracy,"/",len(outputs), "  (",accuracy/len(outputs)*100,")")
...
if __name__ == "__main__":
    ...
    parser.add_argument("isTrain", type=str, help="Train -> true, Test -> false", default="True")
    parser.add_argument("batch_size", type=int, help="batch size", default="126")

    args = parser.parse_args()

    main(args.dataset_path, args.model_path, args.isTrain, args.batch_size)
